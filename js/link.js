document.getElementById("date").textContent = "12/30";// 更新日期
document.getElementById("date").style.color = "#41ff00";

document.getElementById("version").textContent = "V176";// 更新版本号
...
document.getElementById("downloadButton1").addEventListener("click", function() {
  redirect('https://dlink.host/lanzou/aHR0cHM6Ly93d3lyLmxhbnpvdXUuY29tL2lxVXkzMWpkZGs0YiZwYXNzQ29kZT1oZnly.jpg');
});
// 正式版链接
