document.getElementById("date").textContent = "12/26";// 更新日期
document.getElementById("date").style.color = "#41ff00";

document.getElementById("version").textContent = "V172";// 更新版本号
...
document.getElementById("downloadButton1").addEventListener("click", function() {
  redirect('https://dlink.host/lanzou/aHR0cHM6Ly93d3lyLmxhbnpvdXUuY29tL2lqU01vMWowNXBnaCZwYXNzQ29kZT04djI4.jpg');
});
// 正式版链接
