document.getElementById("date").textContent = "12/31";// 更新日期
document.getElementById("date").style.color = "#41ff00";

document.getElementById("version").textContent = "V177";// 更新版本号
...
document.getElementById("downloadButton1").addEventListener("click", function() {
  redirect('https://dlink.host/lanzou/aHR0cHM6Ly93d3AubGFuem91cC5jb20vaUxRTDAxamcxNXZlJnBhc3NDb2RlPTUzdG4.jpg');
});
// 正式版链接
