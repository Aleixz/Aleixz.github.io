...
document.getElementById("link01").target = "_blank";

// 设置字体大小和颜色
document.getElementById("link01").style.fontSize = "16px";
document.getElementById("link01").style.color = "white";
...
document.getElementById("link02").target = "_blank";

// 设置字体大小和颜色
document.getElementById("link02").style.fontSize = "16px";
document.getElementById("link02").style.color = "white";
